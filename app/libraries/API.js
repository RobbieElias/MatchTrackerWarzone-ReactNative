      ...
      case 200:
        ...
        switch (apiErrorMessage) {
          case "Not permitted: user not found":
            return {status: 404, message: "Not found. Incorrect username or platform? Misconfigured privacy settings?"};
          ...
          case "Error from datastore":
            return {status: 500, message: "Internal server error. Request failed, try again."};
          default:
            return {status: 500, message: apiErrorMessage};
        }
        break;
      case 401:
        return {status: 401, message: "Unauthorized. Incorrect username or password."};
      case 403:
        return {status: 403, message: "Forbidden. You may have been IP banned. Try again in a few minutes."};
      case 500:
        return {status: 500, message: "Internal server error. Request failed, try again."};
      case 502:
        return {status: 502, message: "Bad gateway. Request failed, try again."};
      default:
...
module.exports = function (config = {}) {
  ...
  module.modes = {
    ...
    'br_brbbduos': 'Stim Duos',
    'br_brduostim_name2': 'Stim Duos',
    'br_brduohwn': 'BR Duos (Night)',
    'br_74': 'BR Trios',
    'br_77': 'BR Trios',
    'br_25': 'BR Trios',
    'br_brtrios': 'BR Trios',
    ...
    'br_brbbtrios': 'Stim Trios',
    'br_jugg_brtriojugr': 'Juggernaut Trios',
    'br_brhwntrios': 'BR Trios (Night)',
    'br_kingslayer_kingsltrios': 'King Slayer Trios',
    'br_89': 'BR Quads',
    'br_brquads': 'BR Quads',
    'br_brz_brquads': 'BR Quads',
    'br_brbbquad': 'Buy Back Quads',
    'br_brthquad': 'BR Quads 200',
    'br_jugg_brquadjugr': 'Juggernaut Quads',
    'br_86': 'Realism Quads',
    'br_br_real': 'Realism Quads',
    ...
    'br_rebirth_resurgence_mini': 'Resurgence Mini',
    'br_mini_rebirth_mini_royale_duos': 'Rebirth Mini Duos',
    'br_mini_rebirth_mini_royale_trios': 'Rebirth Mini Trios',
    'br_mini_rebirth_mini_royale_quads': 'Rebirth Mini Quads',
    'br_76': 'Plunder',
    'br_85': 'Plunder',
    'br_104': 'Plunder',
  ...
  module.login = function (email, password) {
    return new Promise((resolve, reject) => {
      let randomId = _helpers.makeid(16);
      let deviceId = md5.hex_md5(randomId);
      _helpers
        ...
        .then((response) => {
          ...
          _helpers
            ...
            .then((data) => {
              if (!data.success) {
                reject(_helpers.apiErrorHandling({
                  status: 401,
  ...
  module.WWIIScheduledAchievements = function (
    gamertag,
